...
function [result_ca_filt_data_ct, result_data_cell] = fxn_MPPCA_ca_data_process_v3(data_cell, ca_raw_data, bin_frame_num, sample_fps, filter_mode, z_mode, cutoff_mode, mu_mode);
%% for debug
% bin_frame_num = 20;
%% Parameters
% sample_fps   = 20; % 20hz
