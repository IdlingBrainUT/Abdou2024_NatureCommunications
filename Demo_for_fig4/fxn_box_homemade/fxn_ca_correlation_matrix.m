...
function [res_corr_mat_t, res_corr_mat_n, data_cell_mean] = fxn_ca_correlation_matrix(data_cell, total_session_num, ref_sec_num_from_end)
%% for debug
cell_temp = data_cell;
shift =1; 
...
%
%% figure simple mean correlation matrix
