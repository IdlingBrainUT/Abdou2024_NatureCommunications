function [dot_matrix] = fxn_dual_dot_product(basis_Y, basis_X, color_range, overlap_thr)
%% comment
...
%% filter dot matrix
dot_matrix = dot_matrix > overlap_thr;
%% Figure
figure('Position', [100 200 200 150]);
imagesc(dot_matrix);
% title('Jaccard index')
% xlabel(['Session-', file2_name]); ylabel(['Session-', file1_name]); 
colorbar;
