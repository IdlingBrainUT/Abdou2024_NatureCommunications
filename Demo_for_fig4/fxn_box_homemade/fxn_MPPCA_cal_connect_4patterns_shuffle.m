...
temp_ca_B = temp_ca_shuffled{2}{i_shuffle, 1}(:, P2_unique);
temp_ca_C = temp_ca_shuffled{3}{i_shuffle, 1}(:, P3_unique);
temp_ca_D = temp_ca_shuffled{4}{i_shuffle, 1}(:, P4_unique);
...
% gpu cal
% Cells_A_sum = gpuArray(Cells_A_sum);
% Cells_B_sum = gpuArray(Cells_B_sum);
% Cells_C_sum = gpuArray(Cells_C_sum);
% Cells_D_sum = gpuArray(Cells_D_sum);
% Cells_sum   = gpuArray(Cells_sum);
